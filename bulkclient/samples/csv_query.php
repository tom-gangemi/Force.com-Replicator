...
$myBulkApiConnection->setLoggingEnabled(false); // optional
...
while($batch->getState() == "Queued" || $batch->getState() == "InProgress") {
    sleep(10); //wait for 5 seconds before polling again. in the real world, probably make this exponential as to not ping the server so much
